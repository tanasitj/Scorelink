    ...
    (function (DocumentViewerDemo) {
        ...
        var ViewPart = /** @class */ (function () {
            ...
            ViewPart.prototype.setViewMode = function (isSvg) {
                ...
                this._mainApp.documentViewer.commands.run(lt.Document.Viewer.DocumentViewerCommands.viewItemType, isSvg ? lt.Document.Viewer.DocumentViewerItemType.svg : lt.Document.Viewer.DocumentViewerItemType.image);
                // Check as svg button
